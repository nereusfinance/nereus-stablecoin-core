...
const deployFunction: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log(`${prefix}Cauldron will use ${prefix}VOracle ${oracleAddress}`)
  console.log(`${prefix}Cauldron will use ${prefix}Vault ${collateralAddress} as collateral`)
