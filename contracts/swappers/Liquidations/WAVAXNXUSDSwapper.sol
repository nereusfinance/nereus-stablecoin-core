...
contract WAVAXNXUSDSwapper is ISwapperGeneric {
  ...
  function swap(
      ...
      (uint256 amountFrom, ) = DEGENBOX.withdraw(WAVAX, address(this), address(this), 0, shareFrom);

//      WAVAX => USDT.e
      _traderJoeSwap(WAVAX, WAVAX_USDTe, amountFrom);

      uint256 usdteAmount = USDTe.balanceOf(address(this));

//      USDT.e => NXUSD
      uint256 amountTo = ZAP3POOL.exchange_underlying(NXUSD3POOL, 3, 0, usdteAmount, 0, address(DEGENBOX));
