...
contract WXT_NXUSD is BoringOwnable, IMasterContract {
    ...
    WXT_NXUSD public immutable masterContract;
    ...
    constructor(IBentoBoxV1 bentoBox_, IERC20 magicInternetMoney_, WhitelistManager whitelistManager_) public {
        bentoBox = bentoBox_;
