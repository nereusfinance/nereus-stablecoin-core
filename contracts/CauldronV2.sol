...
contract CauldronV2 is BoringOwnable, IMasterContract {
    ...
    LiquidatorManager public immutable liquidatorManager;
    ...
    constructor(IBentoBoxV1 bentoBox_, IERC20 nereusStableCoin_, LiquidatorManager liquidatorManager_) public {
        bentoBox = bentoBox_;
    ...
    function liquidate(
        ...
        (, bool isApproved) = liquidatorManager.liquidatorsInfo(msg.sender);
        require(isApproved, "sender is not approved as liquidator");
